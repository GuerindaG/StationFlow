...
<head>
    ...
    <title>Bienvenu sur StationFlow</title>
                ...
                <div class="col-xl-5 col-lg-4 d-flex align-items-center">
                    <div class="list-inline ms-auto d-lg-block d-none">
                        ...
                        <div class="list-inline-item">
                            <a href="" class="btn btn-dark d-none d-xl-block">Se connecter</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default"
                ...
                <div class="offcanvas-header pb-1">
                    <a href=""><img src="../assets/images/logo/stationflow-logo.svg"
                ...
                <div class="offcanvas-body">
                    <div>
                        <ul class="navbar-nav align-items-center">
                            <li class="dropdown me-5 d-none d-lg-block"></li>
                            <li class="dropdown me-5 d-none d-lg-block"></li>
                            <li class="dropdown me-5 d-none d-lg-block"></li>
                            <li class="dropdown me-5 d-none d-lg-block"></li>
                            <li class="dropdown me-5 d-none d-lg-block"></li>
                            ...
                            <li class="dropdown me-5 d-none d-lg-block"></li>
                             <li class="nav-item ">
                                <i class="fas fa-home"></i><a class="nav-link" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"> Accueil</a>
                            </li>
                            <li class="nav-item ">
                                <i class="fas fa-map"></i><a class="nav-link" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"> Carte</a>
                            </li>
                            <i class="fas fa-list"></i><a class="nav-link" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false"> Stations</a>
                            </li>
                            <i class="fas fa-tag"></i><a class="nav-link" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false"> Promotions</a>
                            </li>
                            <i class="fas fa-info-circle"></i><a class="nav-link" href="#" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false"> À propos</a>
                            </li>
                            <i class="fas fa-envelope"></i><a class="nav-link" href="#" role="button"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="my-10 text-center">
                        <img src="../assets/images/svg-graphics/delivery-boy.svg" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center mb-6">
                    <div class="col-lg-10 col-10">
                        ...
                        <h3 class="align-items-center d-flex mb-0 h4">
                            ...
                            <span class="ms-3">FreshCart Popular Products</span>
                        </h3>
                    </div>
                        ...
                        <div class="col">
                            <div class="card border-0 card-hover">
                                ...
                                <div class="position-absolute bg-dark-info w-100 bottom-0 py-3 px-4 rounded-bottom">
                                    <a href="#" class="text-white d-flex align-items-center btn-transition">
                                        Offer
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <h2 class="fs-6"><a href="#!" class="text-inherit text-decoration-none">Epigamia
                                                Blueberry Greek Yogurt, 90g</a></h2>
                                        <div>
                                            <!-- rating -->
                                            <small class="text-warning">
                                                <i class="bi bi-star-fill"></i>
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <h2 class="fs-6"><a href="#!" class="text-inherit text-decoration-none">Slurrp
                                                Farm No Maida Millet Pancake Mix</a></h2>
                                        <div>
                                            <!-- rating -->
                                            <small class="text-warning">
                                                <i class="bi bi-star-fill"></i>
        ...
        <div class="container mb-10">
            <div class="row">
                <div class="col-12 d-grid">
                    <a href="#!" class="btn btn-soft-warning btn-lg ls-xl text-uppercase rounded-pill">Save an extra 15%
                        on Authorship order</a>
                </div>
            </div>
        </div>
        <!-- section -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        ...
                        <!-- text -->
                        <div>
                            <h4 class="h5"><a href="#!" class="text-inherit">Almond Butter Chocolate Chip Zucchini
                                    Bars</a></h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        <div class="mb-4">
                            <a href="#!">
                                <!-- img -->
                                <div class="img-zoom">
                                    <img src="../assets/images/blog/blog-img-3.jpg" alt=""
                                        class="img-fluid rounded w-100" />
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        <div class="mb-4">
                            <a href="#!">
                                <!-- img -->
                                <div class="img-zoom">
                                    <img src="../assets/images/blog/blog-img-4.jpg" alt=""
                                        class="img-fluid rounded w-100" />
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="mb-6 border-end-lg p-md-4 px-xl-12 text-center">
                            <div>
                                ...
                                <p class="mb-0">Cheaper prices than your local supermarket, great cashback offers to top
                                    it off.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="mb-6 p-md-4 px-xl-12 text-center">
                            <div>
                                ...
                                <p class="mb-0">Choose from 5000+ products across food, personal care, household & other
                                    categories</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="d-flex">
                            ...
                            <div class="mt-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-map-pin text-primary">
                                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                                    <circle cx="12" cy="10" r="3"></circle>
                                </svg>
                            </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Apr 2025 12:35:29 GMT -->
